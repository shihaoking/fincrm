    ...
    <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            <ul class="am-list admin-sidebar-list">
                ...
                <li><a href="/salesman/list"><span class="am-icon-table"></span><span class="admin-nav-title">业务员</span></a></li>
                <li><a href="/customer/list"><span class="am-icon-users"></span><span class="admin-nav-title">客户</span></a></li>
            </ul>
        </div>
    </div>
    <!-- sidebar end -->
