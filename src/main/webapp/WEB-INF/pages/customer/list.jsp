    ...
    <div class="am-u-sm-12 am-u-md-3">
        <div class="am-form-group">
            <select data-am-selected="{btnSize: 'sm'}">
                ...
                <option value="option2">金世豪</option>
                <option value="option3">郭静文</option>
            </select>
        </div>
    </div>
    <div class="am-u-sm-12 am-u-md-3">
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
                ...
                <c:forEach var="customerInfo" items="${customerList}" begin="0">
                    <tr>
                        ...
                        <td class="am-hide-sm-only"><fmt:formatDate value="${customerInfo.createTime}" type="both" dateStyle="full" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
                        <td>
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
